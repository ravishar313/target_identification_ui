      ...
      <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div className="flex-1 flex flex-col sm:flex-row gap-2">
          <div className="flex-1">
            <input
              type="text"
              placeholder="Search PDB structures..."
              value={searchTerm}
              onChange={(e) => {
            ...
            {getCurrentPagePDBs().map((pdb) => (
              ...
              >
                <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-blue-600">
                  <a href={`https://www.rcsb.org/structure/${pdb.pdb_id}`} target="_blank" rel="noopener noreferrer">
                    {pdb.pdb_id}
                  </a>
                </td>
          ...
          <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
            ...
            <div>
              <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                ...
                {/* Page numbers - similar pagination implementation as in TargetFiltering */}
